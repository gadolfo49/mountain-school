...
add('protected release marker',()=>assert.equal(guard.release,'MF-R5.2-AUDIENCE-UNIFIED-20260912'));
...
add('R5.2 marker',contains('html','MF-R5.2-AUDIENCE-UNIFIED-20260912'));
...
add('R5.2 service worker cache',contains('sw','mountain-family-shell-r5-2-audience-unified-20260912'));add('SW caches runtime',contains('sw',"'./runtime-v2.js'"));add('SW excludes Supabase',contains('sw',"hostname.includes('supabase.co')"));add('SW no legacy auth',notContains('sw','auth-v5.js'));
