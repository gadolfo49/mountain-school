...
test('R5.2 unified audience marker is published',()=>assert.ok(html.includes('MF-R5.2-AUDIENCE-UNIFIED-20260912')));
...
test('service worker is bumped for audience release',()=>assert.ok(sw.includes('mountain-family-shell-r5-2-audience-unified-20260912')));
