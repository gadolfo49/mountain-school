...
check_200 "$BASE/?smoke=20260912-13"
grep -q 'MF-20260912.13' /tmp/mf_body
...
check_200 "$BASE/sw.js?smoke=20260912-13"
grep -q 'mountain-family-shell-v8' /tmp/mf_body
echo 'LIVE_SMOKE_OK_V13'